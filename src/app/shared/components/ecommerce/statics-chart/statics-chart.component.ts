...
import { AfterViewInit, Component, ElementRef, ChangeDetectionStrategy, viewChild } from '@angular/core';
...
export class StatisticsChartComponent implements AfterViewInit {
  readonly datepicker = viewChild.required<ElementRef<HTMLInputElement>>('datepicker');
